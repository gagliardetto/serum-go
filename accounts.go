...
type requestViewContainer struct {
	Enum        ag_binary.BorshEnum `borsh_enum:"true"`
	NewOrder    RequestViewNewOrder
	CancelOrder RequestViewCancelOrder
}

type RequestViewNewOrder struct {
	Side              Side
	OrderType         OrderType
	OwnerSlot         uint8
	FeeTier           FeeTier
	OrderId           ag_binary.Uint128
	MaxCoinQty        uint64
	NativePcQtyLocked *uint64 `bin:"optional"`
	Owner             [4]uint64
	ClientOrderId     *uint64 `bin:"optional"`
	SelfTradeBehavior SelfTradeBehavior
}

func (obj RequestViewNewOrder) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	...
	// Serialize `NativePcQtyLocked` param (optional):
	{
		if obj.NativePcQtyLocked == nil {
...
func (obj *RequestViewNewOrder) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Side`:
	...
	// Deserialize `NativePcQtyLocked` (optional):
	{
...
func (_ *RequestViewNewOrder) isRequestView() {}

type RequestViewCancelOrder struct {
	Side              Side
	OrderId           ag_binary.Uint128
	CancelId          uint64
	ExpectedOwnerSlot uint8
	ExpectedOwner     [4]uint64
	ClientOrderId     *uint64 `bin:"optional"`
}

func (obj RequestViewCancelOrder) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Serialize `Side` param:
	err = encoder.Encode(obj.Side)
	if err != nil {
		return err
	...
	// Serialize `CancelId` param:
	err = encoder.Encode(obj.CancelId)
	if err != nil {
		return err
	}
	// Serialize `ExpectedOwnerSlot` param:
	err = encoder.Encode(obj.ExpectedOwnerSlot)
	if err != nil {
		return err
	}
	// Serialize `ExpectedOwner` param:
	err = encoder.Encode(obj.ExpectedOwner)
	if err != nil {
		return err
	}
	// Serialize `ClientOrderId` param (optional):
...
func (obj *RequestViewCancelOrder) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Side`:
	err = decoder.Decode(&obj.Side)
	if err != nil {
		return err
	...
	// Deserialize `CancelId`:
	err = decoder.Decode(&obj.CancelId)
	if err != nil {
		return err
	}
	// Deserialize `ExpectedOwnerSlot`:
	err = decoder.Decode(&obj.ExpectedOwnerSlot)
	if err != nil {
		return err
	}
	// Deserialize `ExpectedOwner`:
	err = decoder.Decode(&obj.ExpectedOwner)
	if err != nil {
		return err
	}
	// Deserialize `ClientOrderId` (optional):
...
func (_ *RequestViewCancelOrder) isRequestView() {}
...
type eventViewContainer struct {
	Enum ag_binary.BorshEnum `borsh_enum:"true"`
	Fill EventViewFill
	Out  EventViewOut
}

type EventViewFill struct {
	Side              Side
	Maker             bool
	NativeQtyPaid     uint64
...
func (obj EventViewFill) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Serialize `Side` param:
	err = encoder.Encode(obj.Side)
	if err != nil {
		return err
	...
	// Serialize `NativeQtyReceived` param:
	err = encoder.Encode(obj.NativeQtyReceived)
	if err != nil {
		return err
	}
	// Serialize `NativeFeeOrRebate` param:
...
func (obj *EventViewFill) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Side`:
	err = decoder.Decode(&obj.Side)
	if err != nil {
		return err
	...
	// Deserialize `NativeQtyReceived`:
	err = decoder.Decode(&obj.NativeQtyReceived)
	if err != nil {
		return err
	}
	// Deserialize `NativeFeeOrRebate`:
...
func (_ *EventViewFill) isEventView() {}

type EventViewOut struct {
	Side                 Side
	ReleaseFunds         bool
	NativeQtyUnlocked    uint64
	NativeQtyStillLocked uint64
	OrderId              ag_binary.Uint128
	Owner                [4]uint64
	OwnerSlot            uint8
	ClientOrderId        *uint64 `bin:"optional"`
...
func (obj EventViewOut) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Serialize `Side` param:
	err = encoder.Encode(obj.Side)
	if err != nil {
		return err
	}
	// Serialize `ReleaseFunds` param:
	err = encoder.Encode(obj.ReleaseFunds)
	if err != nil {
		return err
	}
	// Serialize `NativeQtyUnlocked` param:
	err = encoder.Encode(obj.NativeQtyUnlocked)
	if err != nil {
		return err
	}
	// Serialize `NativeQtyStillLocked` param:
	err = encoder.Encode(obj.NativeQtyStillLocked)
	if err != nil {
		return err
	}
	// Serialize `OrderId` param:
...
func (obj *EventViewOut) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Side`:
	err = decoder.Decode(&obj.Side)
	if err != nil {
		return err
	}
	// Deserialize `ReleaseFunds`:
	err = decoder.Decode(&obj.ReleaseFunds)
	if err != nil {
		return err
	}
	// Deserialize `NativeQtyUnlocked`:
	err = decoder.Decode(&obj.NativeQtyUnlocked)
	if err != nil {
		return err
	}
	// Deserialize `NativeQtyStillLocked`:
	err = decoder.Decode(&obj.NativeQtyStillLocked)
	if err != nil {
		return err
	}
	// Deserialize `OrderId`:
...
func (_ *EventViewOut) isEventView() {}
