...
func (inst NewOrderV2) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: ag_binary.TypeIDFromUint32(Instruction_NewOrderV2, binary.LittleEndian),
	}}
}
...
func (inst *NewOrderV2) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		...
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("NewOrderV2")).
				//
...
func NewNewOrderV2Instruction(
	...
	return NewNewOrderV2InstructionBuilder().
		SetArgs(args).
