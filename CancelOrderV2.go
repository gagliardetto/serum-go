...
// the OpenOrders owner
func (inst *CancelOrderV2) SetOpenOrdersOwnerAccount(openOrdersOwner ag_solanago.PublicKey) *CancelOrderV2 {
...
// the OpenOrders owner
func (inst *CancelOrderV2) GetOpenOrdersOwnerAccount() *ag_solanago.AccountMeta {
